...
type TenantRegistryStatus struct {
	...
	// ReferencingTemplates is the number of TenantTemplates referencing this registry
	// +optional
	ReferencingTemplates int32 `json:"referencingTemplates,omitempty"`

	// Desired is the total number of Tenant CRs that should exist
...
// +kubebuilder:printcolumn:name="Desired",type="integer",JSONPath=".status.desired",description="Total tenant CRs (Templates * Rows)"
