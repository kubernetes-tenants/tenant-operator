...
type LynqFormSpec struct {
	// RegistryID references the LynqHub that this form is associated with
...
// +kubebuilder:printcolumn:name="Hub",type="string",JSONPath=".spec.registryId",description="LynqHub reference"
