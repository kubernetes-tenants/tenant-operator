...
flowchart LR
    ...
    Template -->|"defines"| Tenant
    Tenant -->|"1. creates"| ManagedRes
    Tenant -->|"2. creates"| K8s["K8s Resources<br/>(Deployments, Services)"]
    ManagedRes -->|"provisions"| CloudRes

    classDef tenant fill:#e3f2fd,stroke:#2196f3,stroke-width:2px;
    classDef crossplane fill:#e8f5e9,stroke:#4caf50,stroke-width:2px;
    classDef cloud fill:#fff8e1,stroke:#ffc107,stroke-width:2px;

    class Template,Tenant tenant;
