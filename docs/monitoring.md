...
| **Registry Metrics** |
| `registry_desired` | Gauge | Desired LynqNode CRs for a registry | `registry`, `namespace` |
| `registry_ready` | Gauge | Ready LynqNode CRs for a registry | `registry`, `namespace` |
| `registry_failed` | Gauge | Failed LynqNode CRs for a registry | `registry`, `namespace` |
| **Apply Metrics** |
