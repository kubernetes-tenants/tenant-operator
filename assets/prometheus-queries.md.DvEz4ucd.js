...
<span class="line"><span>topk(10, tenant_degraded_status)</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Degraded tenants with resources not ready (v1.1.4+)</span></span>
<span class="line"><span>tenant_degraded_status{reason=&quot;ResourcesNotReady&quot;} == 1</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Count by specific degraded reason</span></span>
<span class="line"><span>sum(tenant_degraded_status{reason=&quot;ResourcesNotReady&quot;})</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Tenants with resource failures only</span></span>
<span class="line"><span>tenant_degraded_status{reason=&quot;ResourceFailures&quot;} == 1</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Tenants with conflicts only</span></span>
<span class="line"><span>tenant_degraded_status{reason=&quot;ResourceConflicts&quot;} == 1</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Tenants with both failures and conflicts</span></span>
<span class="line"><span>tenant_degraded_status{reason=&quot;ResourceFailuresAndConflicts&quot;} == 1</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br></div></div><h3 id="resource-health-by-tenant" tabindex="-1">Resource Health by Tenant <a class="header-anchor" href="#resource-health-by-tenant" aria-label="Permalink to &quot;Resource Health by Tenant&quot;">​</a></h3><div class="language-promql line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">promql</span><pre class="shiki github-dark vp-code" tabindex="0"><code><span class="line"><span># Ready resources per tenant</span></span>
...
<span class="line"><span>histogram_quantile(0.95, rate(tenant_reconcile_duration_seconds_bucket[5m])) &gt; 30</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Resources not ready (v1.1.4+)</span></span>
<span class="line"><span>tenant_degraded_status{reason=&quot;ResourcesNotReady&quot;} &gt; 0</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Tenants with both failures and conflicts (v1.1.4+)</span></span>
<span class="line"><span>tenant_degraded_status{reason=&quot;ResourceFailuresAndConflicts&quot;} &gt; 0</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><h2 id="v1-1-4-enhanced-status-queries" tabindex="-1">v1.1.4 Enhanced Status Queries <a class="header-anchor" href="#v1-1-4-enhanced-status-queries" aria-label="Permalink to &quot;v1.1.4 Enhanced Status Queries&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">New in v1.1.4</p><p>v1.1.4 introduces more granular degraded condition reasons and smart reconciliation with 30-second requeue interval.</p></div><h3 id="new-degraded-reasons" tabindex="-1">New Degraded Reasons <a class="header-anchor" href="#new-degraded-reasons" aria-label="Permalink to &quot;New Degraded Reasons&quot;">​</a></h3><div class="language-promql line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">promql</span><pre class="shiki github-dark vp-code" tabindex="0"><code><span class="line"><span># All tenants degraded due to resources not ready</span></span>
<span class="line"><span>tenant_degraded_status{reason=&quot;ResourcesNotReady&quot;} == 1</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Tenants with resource failures only</span></span>
<span class="line"><span>tenant_degraded_status{reason=&quot;ResourceFailures&quot;} == 1</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># Tenants with both failures and conflicts</span></span>
<span class="line"><span>tenant_degraded_status{reason=&quot;ResourceFailuresAndConflicts&quot;} == 1</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Count tenants by degraded reason</span></span>
<span class="line"><span>sum(tenant_degraded_status == 1) by (reason)</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><h3 id="ready-condition-granularity" tabindex="-1">Ready Condition Granularity <a class="header-anchor" href="#ready-condition-granularity" aria-label="Permalink to &quot;Ready Condition Granularity&quot;">​</a></h3><p>Check why tenants are not ready:</p><div class="language-promql line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">promql</span><pre class="shiki github-dark vp-code" tabindex="0"><code><span class="line"><span># All not-ready tenants with detailed reason</span></span>
<span class="line"><span>tenant_condition_status{type=&quot;Ready&quot;} != 1</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Degraded tenants with Ready=False</span></span>
<span class="line"><span>tenant_condition_status{type=&quot;Ready&quot;} != 1 and tenant_condition_status{type=&quot;Degraded&quot;} == 1</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Query tenant annotations for reason details (requires external tooling)</span></span>
<span class="line"><span># Reasons: ResourcesFailedAndConflicted, ResourcesConflicted,</span></span>
<span class="line"><span>#          ResourcesFailed, NotAllResourcesReady</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><h3 id="smart-reconciliation-monitoring" tabindex="-1">Smart Reconciliation Monitoring <a class="header-anchor" href="#smart-reconciliation-monitoring" aria-label="Permalink to &quot;Smart Reconciliation Monitoring&quot;">​</a></h3><p>Monitor the 30-second requeue behavior:</p><div class="language-promql line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">promql</span><pre class="shiki github-dark vp-code" tabindex="0"><code><span class="line"><span># Reconciliation frequency (should show ~2 per minute per tenant in v1.1.4+)</span></span>
<span class="line"><span>rate(tenant_reconcile_duration_seconds_count[5m])</span></span>
<span class="line"><span></span></span>
