...
func TestCreationPolicyOnce_WithRetain_NoReAdoption(t *testing.T) {
	...
	orphanedConfigMap := &corev1.ConfigMap{
		ObjectMeta: metav1.ObjectMeta{
			...
			Annotations: map[string]string{
				...
				"lynq.sh/orphaned-reason": "TenantDeleted",
	...
	assert.Equal(t, "TenantDeleted", updatedConfigMap.Annotations["lynq.sh/orphaned-reason"],
	...
	readyCondition := findCondition(updatedLynqNode.Status.Conditions, ConditionTypeReady)
